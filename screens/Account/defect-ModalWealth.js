...
import {
  setMonth, setAsetLancar, setAsetInvestasi, setAsetGuna, setUtang, setModal,
...
class modalWealth extends Component {
  ...
  componentDidMount(){
    ...
    console.log("key:"+this.props.keyAset)
  }
  ...
  editModal =()=>{
    ...
    switch(this.props.akun){
      case "Rekening":
        this.props.updateAsetLancar(this.state, this.props.keyAset)
        break;
      case "Piutang":
...
const styles = StyleSheet.create({
  ...
  const mapDispatchToProps = dispatch => {
    return {
      ...
      updateAsetLancar: (aset,key) => dispatch(updateAsetLancar(aset, key)),
